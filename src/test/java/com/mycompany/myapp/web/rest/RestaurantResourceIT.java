...
class RestaurantResourceIT {
    ...
    void getAllRestaurants() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].dateOuverture")
            .value(hasItem(DEFAULT_DATE_OUVERTURE.toString()))
            .jsonPath("$.[*].dateFermiture")
            .value(hasItem(DEFAULT_DATE_FERMITURE.toString()));
    }
    ...
    void getRestaurant() {
        ...
        webTestClient
            ...
            .jsonPath("$.dateOuverture")
            .value(is(DEFAULT_DATE_OUVERTURE.toString()))
            .jsonPath("$.dateFermiture")
            .value(is(DEFAULT_DATE_FERMITURE.toString()));
    }
